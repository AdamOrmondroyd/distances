...
from nocepheid import corrected_ia_likelihood
import pypolychord
...
def likelihood(theta):
    ...
    return desi_likelihood(h0rd, omegam, omegar, theta) + corrected_ia_likelihood(Mb, h0, omegam, omegar, theta)


file_root = f"tognocepheid_corrected_{n}"
